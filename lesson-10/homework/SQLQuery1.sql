...
-----3. Employeesva Departmentsjadvallaridan foydalanib , barcha xodimlarni bo'lim nomlari bilan birga ko'rsatish uchun so'rov yozing. 
----Hech qanday bo'limga tegishli bo'lmagan xodimlarni kiriting.
...
----- 5. Ordersva Paymentsjadvallaridan foydalanib , barcha buyurtmalarni va ularning tegishli to'lovlarini qaytarish uchun so'rov yozing. 
----To'lovsiz buyurtmalarni va hech qanday buyurtma bilan bog'lanmagan to'lovlarni qo'shing.
---🔁 Kutilayotgan ustunlar: OrderID , OrderDate, PaymentDate,Amount
...
-----. 10 . Employeesva Departmentsjadvallaridan foydalanib , 5 dan ortiq xodimga ega bo'lim nomlarini qaytarish uchun so'rov yozing.
--- 🔁 Kutilayotgan ustunlar: DepartmentName ,EmployeeCount
...
----17. Ordersva Paymentsjadvallaridan foydalanib , faqat tegishli to'lovga ega bo'lgan buyurtmalarni qaytarish uchun so'rov yozing.
---🔁 Kutilayotgan ustunlar: OrderID , OrderDate, PaymentDate,Amount
...
----18.  Productsva Ordersjadvallaridan foydalanib , hech qachon buyurtma berilmagan mahsulotlarni topish uchun so'rov yozing.
---🔁 Kutilayotgan ustunlar: ProductID ,ProductName
...
------ 19. EmployeesJadvaldan foydalanib , o'z bo'limlarida ish haqi o'rtacha ish haqidan yuqori bo'lgan xodimlarni topish uchun so'rov yozing.
--🔁 Kutilayotgan ustunlar: EmployeeName ,Salary
...
--------24. Productsva Salesjadvallaridan foydalanib , mahsulot nomlarini o'z ichiga olgan holda miqdori 500 dan ortiq bo'lgan sotuvlar ro'yxati uchun so'rov yozing.
--🔁 Kutilayotgan ustunlar: SaleID , ProductName,SaleAmount
...
------25. Students, Courses, va Enrollmentsjadvallardan foydalanib , "Matematik 101" kursiga yozilmagan talabalarni topish uchun so'rov yozing .
...
---🔁 Kutilayotgan ustunlar: OrderID , OrderDate,PaymentID
