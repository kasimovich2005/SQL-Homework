...
---- 1. Qaytish : OrderID, CustomerName, OrderDate
--Vazifa : 2022 yildan keyin berilgan barcha buyurtmalarni ularni joylashtirgan mijozlarning ismlari bilan birga ko‘rsating.
--Ishlatilgan jadvallar : Orders,Customers
...
----2. Qaytish : EmployeeName, DepartmentName
---Vazifa : Savdo yoki marketing bo'limida ishlaydigan xodimlarning ismlarini ko'rsating.
--Ishlatilgan jadvallar : Employees,Departments
...
---- 3. Qaytish : DepartmentName, MaxSalary
---Vazifa : Har bir bo'lim uchun eng yuqori ish haqini ko'rsating.
--Ishlatilgan jadvallar : Departments,Employees
...
----- 4. Qaytish : CustomerName, OrderID, OrderDate
---Vazifa : 2023 yilda AQShdan buyurtma bergan barcha mijozlarni sanab o'ting.
--Ishlatilgan jadvallar : Customers,Orders
...
----- 5. Qaytish : CustomerName, TotalOrders
---Vazifa : Har bir mijoz qancha buyurtma berganligini ko'rsating.
--Ishlatilgan jadvallar : Orders,Customers
...
-----6. Qaytish : ProductName, SupplierName
---Vazifa : Gadget Supplies yoki Clothing Mart tomonidan taqdim etilgan mahsulotlar nomlarini ko'rsatish.
--Ishlatilgan jadvallar : Products,Suppliers
...
----7. Qaytish : CustomerName, MostRecentOrderDate
---Vazifa : Har bir mijoz uchun eng oxirgi buyurtmasini ko'rsating. Hech qanday buyurtma bermagan mijozlarni qo'shing.
--Ishlatilgan jadvallar : Customers,Orders
...
------------ ✅ Medium-Level SQL Tasks  --------- 

/*    #8 ---- 
Qaytish : CustomerName, OrderTotal
Vazifa : Umumiy miqdori 500 dan ortiq bo'lgan buyurtma bergan mijozlarni ko'rsatish.
Ishlatilgan jadvallar : Orders,Customers
*/
...
/*    #9 ---- 
Qaytish : ProductName, SaleDate, SaleAmount
Vazifa : 2022-yilda sotilgan yoki sotish miqdori 400 dan oshgan mahsulot sotuvi roʻyxati.
Ishlatilgan jadvallar : Products,Sales
*/
...
/*    #10 ---- 
Qaytish : ProductName, TotalSalesAmount
Vazifa : Har bir mahsulotni sotilgan umumiy miqdori bilan birga ko'rsating.
Ishlatilgan jadvallar : Sales,Products
*/
...
/*     #11 ---- 
Qaytish : EmployeeName, DepartmentName, Salary
Vazifa : Kadrlar bo'limida ishlaydigan va 60000 dan ortiq maosh oladigan xodimlarni ko'rsating.
Ishlatilgan jadvallar : Employees,Departments
*/
...
/*    #12 ---- 
Qaytish : ProductName, SaleDate, StockQuantity
Vazifa : 2023-yilda sotilgan va o‘sha paytda 100 donadan ortiq zaxiraga ega bo‘lgan mahsulotlarni sanab o‘ting.
Ishlatilgan jadvallar : Products,Sales
*/
...
/*    #13 ---- 
Qaytish : EmployeeName, DepartmentName, HireDate
Vazifa : Savdo bo'limida ishlaydigan yoki 2020 yildan keyin ishga qabul qilingan xodimlarni ko'rsating.
Ishlatilgan jadvallar : Employees,Departments
*/
...
----  13.Return: CustomerName, OrderID, Address, OrderDate
...
WHERE c.Country = 'USA' AND c.Address = '^[0-9]{4}';


----14. Return: ProductName, Category, SaleAmount
