...
SELECT SUM(SaleAmount) AS seven_id_sales
FROM Sales
WHERE ProductID = 7;
...
HAVING AVG(Price) > 400;  -- jadvalda 400 katta raqam yuq 40 qilib kursa ishlaydi
...
SELECT 
    CustomerID,
    SUM(CASE WHEN SaleAmount > 50 THEN SaleAmount ELSE 0 END) AS TotalOver50,
