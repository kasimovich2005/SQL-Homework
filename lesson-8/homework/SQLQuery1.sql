...
--1.Mahsulotlar jadvalidan foydalanib, har bir toifadagi mahsulotlarning umumiy sonini toping.
...
--2. Mahsulotlar jadvalidan foydalanib, "Elektronika" toifasidagi mahsulotlarning o'rtacha narxini oling.
...
--3.Mijozlar jadvalidan foydalanib, "L" harfi bilan boshlangan shaharlardagi barcha mijozlarni ro'yxatlang.
...
--4. Mahsulotlar jadvalidan foydalanib, "er" bilan tugaydigan barcha mahsulot nomlarini oling.
...
--5.Mijozlar jadvalidan foydalanib, "A" bilan tugaydigan mamlakatlardagi barcha mijozlarni ro'yxatlang.

SELECT *
FROM Customers
WHERE City LIKE '%A';

--6.Mahsulotlar jadvalidan foydalanib, barcha mahsulotlar orasida eng yuqori narxni ko'rsating.

SELECT MAX (Price) as MaxPrice_Products
from Products	

--7.Mahsulotlar jadvalidan foydalanib, agar miqdori < 30 bo'lsa, zaxirani "Kam" deb belgilang, aks holda "Etarli".
...
--8.  Mijozlar jadvalidan foydalanib, har bir mamlakatdagi mijozlarning umumiy sonini toping.

SELECT Country, COUNT(*) AS TotalCustomers
FROM Customers
GROUP BY Country;

--9. Buyurtmalar jadvalidan foydalanib, buyurtma qilingan minimal va maksimal miqdorni toping.
...
--- 10. Buyurtmalar va schyot-fakturalar jadvallaridan foydalanib, 2023-yil yanvar oyida buyurtma bergan mijoz identifikatorlarini roʻyxatga kiritib, hisob-fakturalari boʻlmaganlarni toping.



---11. Mahsulotlar va mahsulotlar_chegirmali jadvalidan foydalanib, Mahsulotlar va mahsulotlar_chegirmalaridagi barcha mahsulot nomlarini, shu jumladan dublikatlarni birlashtiring.
...
--- 12.Mahsulotlar va mahsulotlar_chegirmali jadvalidan foydalanib, Mahsulotlar va mahsulotlar_chegirmalaridagi barcha mahsulot nomlarini takroriy holda birlashtiring.

SELECT ProductName FROM Products
UNION
SELECT ProductName FROM Products_Discounted;

---13. Buyurtmalar jadvalidan foydalanib, yil bo'yicha o'rtacha buyurtma miqdorini toping.

SELECT YEAR(OrderDate) AS OrderYear, AVG(TotalAmount) AS AvgOrderAmount
FROM Orders
GROUP BY YEAR(OrderDate);

---14. Mahsulotlar jadvalidan foydalanib, mahsulotlarni narx bo‘yicha guruhlang: “Low” (<100), ‘Mid” (100-500), “High” (>500). Mahsulot nomi va narx guruhini qaytaring.
...
--15.City_Population  jadvalidan foydalanib, Yil ustunining qiymatlarini alohida ustunlarda ([2012], [2013]) koʻrsatish uchun Pivot funksiyasidan foydalaning va natijalarni yangi Aholi_yillik_yil jadvaliga nusxalang.


SELECT district_name,
       [2012], [2013]
INTO PopulationEachYear
FROM (
...
select * from PopulationEachYear


--- 16. Savdo jadvalidan foydalanib, har bir mahsulot identifikatori bo'yicha jami sotishni toping.
...
--- 17. Mahsulotlar jadvalidan foydalanib, nomida "oo" bo'lgan mahsulotlarni topish uchun joker belgidan foydalaning. Mahsulot nomini qaytaring.

SELECT ProductName
FROM Products
WHERE ProductName LIKE '%oo%';

--- 18. Shahar_Aholisi jadvalidan foydalanib, Pivot yordamida Shahar ustunining qiymatlarini alohida ustunlarda (Bektemir, Chilonzor, Yakkasaroy) ko'rsatish va natijalarni yangi Aholi_shahar_jadvaliga nusxalash.
...
-- 19.Hisob-fakturalar jadvalidan foydalanib, eng ko'p umumiy hisob-faktura miqdoriga ega bo'lgan eng yaxshi 3 ta mijozni ko'rsating. CustomerID va Totalsent-ni qaytaring.
...
--- 20. Population_Har_Year jadvalini asl formatiga (City_Population) aylantiring.
