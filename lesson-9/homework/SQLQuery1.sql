...
----1.Mahsulotlar, Yetkazib beruvchilar jadvalidan foydalanish Mahsulot nomlari va yetkazib beruvchi nomlarining barcha kombinatsiyalarini ko'rsating.
...
----- 2.Bo'limlardan foydalanish, Xodimlar jadvali Bo'limlar va xodimlarning barcha kombinatsiyalarini oling.
...
---- 3.Mahsulotlardan foydalanish, Ta'minotchilar jadvali Faqat etkazib beruvchi mahsulotni haqiqatda etkazib beradigan kombinatsiyalarni ko'rsating. 
--Yetkazib beruvchi nomi va mahsulot nomini qaytaring
...
------4. Buyurtmalardan foydalanish, Mijozlar jadvali Mijoz nomlari va ularning buyurtma identifikatori ro'yxati.
...
----5. Kurslardan foydalanish, Talabalar jadvali Talabalar va kurslarning barcha kombinatsiyalarini oling.
...
---- 6.Mahsulotlardan foydalanish, Buyurtmalar jadvali Mahsulot identifikatorlari mos keladigan mahsulot nomlari va buyurtmalarini oling.
...
---- 7. Bo'limlardan foydalanish, Xodimlar jadvali Departament identifikatori bo'limga mos keladigan xodimlar ro'yxati.
...
----8. Talabalardan foydalanish, Ro'yxatga olish jadvali Talabalar ismlari va ularning ro'yxatdan o'tgan kurs identifikatorlari ro'yxati.
...
----- 9. To'lovlar, Buyurtmalar jadvalidan foydalanish mos keladigan to'lovlarga ega bo'lgan barcha buyurtmalarni sanab o'ting.
...
----10. Buyurtmalardan foydalanish, Mahsulotlar jadvali Mahsulot narxi 100 dan ortiq bo'lgan buyurtmalarni ko'rsating.
...
-----11. Xodimlardan foydalanish, Bo'limlar jadvali Bo'lim identifikatorlari teng bo'lmagan xodimlarning ismlari va bo'lim nomlarini ko'rsating.
---------   Buning ma'nosi: barcha mos kelmaydigan xodimlar-bo'lim kombinatsiyalarini ko'rsatish.
...
----- 12.Buyurtmalar, Mahsulotlar jadvalidan foydalanish Buyurtma miqdori zaxira miqdoridan ko'p bo'lgan buyurtmalarni ko'rsating.
...
-----13.Mijozlardan foydalanish, Savdo jadvali Savdo miqdori 500 yoki undan ortiq bo'lgan mijozlar nomlari va mahsulot identifikatorlarini ko'rsating.
...
-----14. Kurslar, Ro'yxatga olishlar, Talabalar jadvalidan foydalanish Talabalar ismlari va ular ro'yxatdan o'tgan kurs nomlarini ko'rsating.
...
----15.		Mahsulotlardan foydalanish, Yetkazib beruvchilar jadvali. Ta'minotchi nomi "Tech" ni o'z ichiga olgan mahsulot va etkazib beruvchi nomlarini ko'rsating.
...
----16. Buyurtmalardan foydalanish, To'lovlar jadvali To'lov miqdori umumiy summadan kam bo'lgan buyurtmalarni ko'rsating.
...
-----17. Xodimlar va bo'limlar jadvallaridan foydalanib, har bir xodim uchun bo'lim nomini oling.
...
-----18. Mahsulotlardan foydalanish, Kategoriyalar jadvali Kategoriyasi "Elektronika" yoki "Mebel" bo'lgan mahsulotlarni ko'rsating.
...
-----19. Savdodan foydalanish, mijozlar jadvali "USA" dan bo'lgan mijozlarning barcha savdolarini ko'rsating.

SELECT s.SaleID, s.ProductID, s.SaleAmount, c.FirstName  +  c.LastName
FROM Sales s
JOIN Customers c ON s.CustomerID = c.CustomerID
WHERE c.Country = 'USA';

-----20. Buyurtmalardan foydalanib, "Mijozlar" jadvali "Germaniya" dan mijozlar tomonidan qilingan buyurtmalar ro'yxati va jami 100 ta buyurtma.
...
----- 21. Xodimlar jadvalidan foydalanish Turli bo'limlarning barcha juftlik xodimlarini ro'yxatlang.
...
----22. To'lovlar, Buyurtmalar, Mahsulotlar jadvalidan foydalanish To'langan summa teng bo'lmagan to'lov tafsilotlari ro'yxati (Miqdor × Mahsulot narxi).
...
------ 23.Talabalar, Ro'yxatga olishlar, Kurslar jadvalidan foydalanish Hech qanday kursga yozilmagan talabalarni toping.
...
----24. Xodimlar jadvalidan foydalanish Birovning menejeri bo'lgan, lekin maoshi ular boshqaradigan odamdan kam yoki unga teng bo'lgan xodimlarni ro'yxatlang.
...
---25. Buyurtmalar, to'lovlar, mijozlar jadvalidan foydalanish Buyurtma bergan, ammo buning uchun to'lov qayd etilmagan mijozlar ro'yxati.
